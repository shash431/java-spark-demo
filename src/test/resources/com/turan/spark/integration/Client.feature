Feature: Client endpoint
  ...
  Scenario:
    ...
    Then I should list 1 client with the name Pamela and updated last name Ericsson when I list
    ...
    Then This time I should list only 1 client with the name Pamela and last name Ericsson
